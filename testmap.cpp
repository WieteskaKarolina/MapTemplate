...
int main(void)
{
	...
	map_template<Title,Library> Database1;					

	Database1.Add("'Wczoraj'",Library("A.B","dramat",28,1)); 	
	Database1.Add("'Dzis'",Library("D.V","dramat",54,1)); 	
	Database1.Add("'Jutro'",Library("K.J","kryminal",32,0));
	cout << Database1 << endl;
}
